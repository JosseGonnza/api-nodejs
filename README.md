# Aprendiendo a usar NodeJS con TypeScript y TypeORM

Generaremos una API REST compleja con NodeJS utilizando como lenguaje core `TypeScript` y `TypeORM` como ORM SQL.
